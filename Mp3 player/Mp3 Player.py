...
from PyQt5.QtWidgets import  QListWidget, QWidget, QApplication, QPushButton, QVBoxLayout, QFileDialog, QHBoxLayout
...
class Mp3Player(QWidget):
    ...
    def klasorAc(self):
        self.dosyaIsmi = QFileDialog.getOpenFileName(
            self, "Dosya Seç", os.getenv("HOME"), "Mp3 (*mp3)")
